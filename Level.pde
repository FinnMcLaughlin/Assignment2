...
class Level
{
 ...
 void LevelStart()
 {
  ...
  /*int Level1(int lev)
  {
    if(frameCount == 60)
             {
               ESprite = new Hive(225, -30, 1, 1, false);
               Enemies.add(ESprite);
               ESprite = new Hive(50, -70, 1, 1, false);
               Enemies.add(ESprite);
               ESprite = new Hive(400, -70, 1, 1, false);
               Enemies.add(ESprite);
             }
             ...
             if(frameCount == 120)
             {
               ...
               {
                 ESprite = new Hive(0+i, -30, 1, 1, false);
                 Enemies.add(ESprite);
               }
             }
             ...
             if(frameCount == 180)
             {
               ...
               for(int i=-25; i < 250; i += 125)
               {
                 ESprite = new Hive(250+i, -100, 1, 1, false);
                 Enemies.add(ESprite);
               }
               for(int i=-25; i < 250; i += 125)
               {
                 ESprite = new Hive(0+i, -170, 1, 1, false);
                 Enemies.add(ESprite);
               }
             }
           ...
           if(frameCount == 300)
           {
             ...
             {
               ESprite = new Hive(-30+i, -30, 1, 1, false);
               Enemies.add(ESprite);
             }
             
             for(int i=0; i < 250; i += 125)
             {
               ESprite = new Hive(350+i, -30, 1, 1, false);
               Enemies.add(ESprite);
             }
